...
#include "disksim_cachembc_param.h"
#include "disksim_cachembc_location_param.h"
#include "disksim_cachemem_param.h"
#include "disksim_cachessd_param.h"
...
static struct lp_mod *disksim_mods[] = {
 ...
 &disksim_cachembc_mod ,
 &disksim_cachembc_location_mod ,
 &disksim_cachemem_mod ,
 &disksim_cachessd_mod ,
 &disksim_ctlr_mod ,
...
typedef enum {
  ...
  DISKSIM_MOD_CACHEMBC,
  DISKSIM_MOD_CACHEMBC_LOCATION,
  DISKSIM_MOD_CACHEMEM,
  DISKSIM_MOD_CACHESSD,
  DISKSIM_MOD_CTLR,
